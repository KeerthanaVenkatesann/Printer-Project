    ...
    <div className="allwin-print">
      <div className="mx-auto text-center">
        ...
        <div className="mt-3 mb-3 ">
          ...
          <h4><TiTickOutline className="fs-2 mb-1" />Best Plans for Your Brand and Budget</h4>
          <p>
            We offer the best plans tailored to fit your brand's needs and your budget.
          </p>
          <h4><TiTickOutline className="fs-2 mb-1" />Comprehensive Advertising and Branding Services</h4>
          <p>
            We provide all your advertising and branding needs under one roof.
          </p>
          <h4><TiTickOutline className="fs-2 mb-1" />On-Time Services</h4>
          <p>
            We are committed to delivering our services on time, every time.
          </p>
          <h4><TiTickOutline className="fs-2 mb-1" />Flexible and Client-Centric Approach</h4>
          <p>
